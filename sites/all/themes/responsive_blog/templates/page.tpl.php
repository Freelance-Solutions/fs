...
<div id="wrapper">
        ...
        <div id="slider">
          <div id="slider-wrap">
            <div class="slides displayblock">
              <a href="<?php print url($slide1_url); ?>"><img width="100%" height="420" src="<?php print base_path() . drupal_get_path('theme', 'responsive_blog') . '/images/slide-image-1.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide1_desc . '</div>'; } ?><!-- .featured-text -->
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="<?php print url($slide2_url); ?>"><img width="100%" height="420" src="<?php print base_path() . drupal_get_path('theme', 'responsive_blog') . '/images/slide-image-2.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide2_desc . '</div>'; } ?><!-- .featured-text -->
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="<?php print url($slide3_url); ?>"><img width="100%" height="420" src="<?php print base_path() . drupal_get_path('theme', 'responsive_blog') . '/images/slide-image-3.jpg'; ?>" class="pngfix"/></a>
  ...
  <footer id="footer-bottom">
    ...
    <div id="bottom" class="clearfix">
      ...
      <div class="credit"><?php print t('Theme by'); ?> Freelance Solutions</div>
    </div>
  </footer>
